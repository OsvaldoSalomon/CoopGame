...
#include "CoopGame/SHealthComponent.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_CoopGame_OnHealthChangedSignature__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "SHealthComponent.h" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USHealthComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USHealthComponent_HandleTakeAnyDamage, "HandleTakeAnyDamage" }, // 234217467
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USHealthComponent, 2755648850);
